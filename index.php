...
switch ($page) {
    ...
    case 'offre':
        ...
        // true pour conserver les clés (1,2,3...) pour l'id dans Twig
        $data['offres']       = array_slice($toutesLesOffres, $offset, $parPage, true);
        $data['pageCourante'] = $p;
    ...
    case 'offre_detail':
        ...
        $offers = require __DIR__ . '/data/offres.php';
